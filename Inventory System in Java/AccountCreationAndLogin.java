...
public class AccountCreationAndLogin {
	...
	static ArrayList<String> Usernames = new ArrayList<>(); //stores the account created username
    static ArrayList<String> Passwords = new ArrayList<>();//stores the account created password
    static ArrayList<String> Types = new ArrayList<>(); //stores the account created type admin/consumer
